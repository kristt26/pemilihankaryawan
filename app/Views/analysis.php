                        ...
                        <table class="table table-sm table-hover table-bordered text-nowrap table-head-fixed ">
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        ...
                                        Nama</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2"
                                        ng-repeat="item in datas.matriks[0].nilai" style="width: 15%;"
                                        class="text-center">
                                        {{item.kode}}</th>
                                    <th
                                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                            ...
                            <tbody>
                                <tr ng-repeat="item in datas.wp.vector">
                                    ...
                                    <td ng-repeat="nilaiKriteria in item.nilai" class="text-center">
                                        <p class="text-sm font-weight-bold mb-0">{{nilaiKriteria.bobot | number : 8}}
                                        </p>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">{{item.vector | number : 8}}</p>
                                        </td8 </tr>
                            </tbody>
                        </table>
                    </div>
                            ...
                            <table class="table table-sm table-hover table-bordered text-nowrap table-head-fixed ">
                                ...
                                <tbody>
                                    <tr
                                        ...
                                        <td>
                                            <p class="text-sm font-weight-bold mb-0">{{item.preferensi | number : 8}}
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
