  ...
  <div class="col-md-12">
    <div class="card card-rri">
      <div class="card-header">
        <h3 class="card-title"><i class="fas fa-th-list"></i>&nbsp;&nbsp; Laporan Pebdapatan</h3>
          ...
          <div class="screen">
            <div class="col-md-12 d-flex justify-content-between">
              ...
              <div class="col-md-12 text-center">
                <h2>LAPORAN PENDAPATAN</h2><h5>TANGGAL: {{model.awal | date: 'd MMMM y'}} S/D {{model.akhir | date: 'd MMMM y'}}</h5>
              </div>
            </div>
          ...
          <table class="table table-sm table-bordered">
            ...
            <tfoot>
              <tr>
                ...
                <td class="text-right">Rp. {{total | currency}}</td>
              </tr>
            </tfoot>
          </table>
        </div>
